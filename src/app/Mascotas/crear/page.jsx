...
const page = () => {
    return (
        <div className='bg-blue-800 w-full min-h-screen flex flex-col items-center '>
            ...
            <img src="/photo-lg-0.svg" alt="" className='w-2/5' />
            <div className='flex flex-col gap-3 px-7 py-[12px] w-full'>
                ...
                <select
                    className='w-[100%] py-3 pl-5 font-semibold opacity-50 rounded-full'>
                    <option value="" className='font-semibold text-opacity-50'>Selecciones una raza</option>
                    <option value="" className='font-semibold opacity-50'>Raza 1</option>
                    <option value="" className='font-semibold opacity-50'>Raza 1</option>
                </select>
                <select
                    className='w-[100%] py-3 pl-5 font-semibold opacity-50 rounded-full'>
                    <option value="" className='font-semibold text-opacity-50'>Selecciones una categoría</option>
                    <option value="" className='font-semibold opacity-50'>Raza 1</option>
                    <option value="" className='font-semibold opacity-50'>Raza 1</option>
                </select>
                <input
